 ...
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}RouteInfo" minOccurs="0"/&gt;
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}CustId" minOccurs="0"/&gt;
 *         &lt;/sequence&gt;
 *         &lt;element ref="{http://aciworldwide.com/S1Adapter}FileStatusInfo"/&gt;
 *         &lt;element ref="{http://aciworldwide.com/S1Adapter}AdditionalFileStatusInfo" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{http://aciworldwide.com/S1Adapter}RefInfo" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{http://aciworldwide.com/S1Adapter}FileStatusRec" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "", propOrder = {
    ...
    "custId",
    "fileStatusInfo",
    "additionalFileStatusInfo",
    "refInfo",
    "fileStatusRec",
    "tunneledData"
})
@XmlRootElement(name = "FileStatusRs")
public class FileStatusRs {
    ...
    @XmlElement(name = "AdditionalFileStatusInfo")
    protected List<FileStatusInfoType> additionalFileStatusInfo;
    @XmlElement(name = "RefInfo")
    protected List<RefInfo> refInfo;
    @XmlElement(name = "FileStatusRec")
    protected List<FileStatusRecType> fileStatusRec;
    ...
    /**
     * Gets the value of the additionalFileStatusInfo property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the additionalFileStatusInfo property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAdditionalFileStatusInfo().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<FileStatusInfoType> getAdditionalFileStatusInfo() {
        if (additionalFileStatusInfo == null) {
            additionalFileStatusInfo = new ArrayList<FileStatusInfoType>();
        }
        return this.additionalFileStatusInfo;
    }
    ...
    /**
     * Gets the value of the fileStatusRec property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the fileStatusRec property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFileStatusRec().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link FileStatusRecType }
     * 
     * 
     */
    public List<FileStatusRecType> getFileStatusRec() {
        if (fileStatusRec == null) {
            fileStatusRec = new ArrayList<FileStatusRecType>();
        }
        return this.fileStatusRec;
    }
