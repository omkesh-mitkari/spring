 ...
 *         &lt;element ref="{http://aciworldwide.com/S1Adapter}PmtCanRq"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "PmtCanInp")
public class PmtCanInp {

    @XmlElement(name = "SignonRq", required = true)
    protected SignonRq signonRq;
    @XmlElement(name = "PmtCanRq", required = true)
    protected PmtCanRq pmtCanRq;
     ...
     *     
     */
    public void setPmtCanRq(PmtCanRq value) {
        this.pmtCanRq = value;
    }
