 ...
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}ForExRateDealType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}ForExDealRec" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;/sequence&gt;
...
@XmlRootElement(name = "ForExDealInqRs")
public class ForExDealInqRs {
    ...
    protected List<String> forExRateDealType;
    @XmlElement(name = "ForExDealRec")
    protected List<ForExDealRecType> forExDealRec;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the forExRateDealType property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getForExRateDealType().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getForExRateDealType() {
        if (forExRateDealType == null) {
            forExRateDealType = new ArrayList<String>();
        }
        return this.forExRateDealType;
    }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the forExDealRec property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getForExDealRec().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ForExDealRecType> getForExDealRec() {
        if (forExDealRec == null) {
            forExDealRec = new ArrayList<ForExDealRecType>();
        }
        return this.forExDealRec;
    }
