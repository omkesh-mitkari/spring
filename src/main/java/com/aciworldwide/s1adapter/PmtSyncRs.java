 ...
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}PmtMsgRec" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;/sequence&gt;
...
public class PmtSyncRs {
    ...
    @XmlElement(name = "PmtMsgRec")
    protected List<PmtMsgRec> pmtMsgRec;
    ...
    /**
     * Gets the value of the pmtMsgRec property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the pmtMsgRec property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPmtMsgRec().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<PmtMsgRec> getPmtMsgRec() {
        if (pmtMsgRec == null) {
            pmtMsgRec = new ArrayList<PmtMsgRec>();
        }
        return this.pmtMsgRec;
    }
