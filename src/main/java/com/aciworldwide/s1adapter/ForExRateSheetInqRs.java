 ...
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}CurCodeRates" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;/sequence&gt;
...
@XmlRootElement(name = "ForExRateSheetInqRs")
public class ForExRateSheetInqRs {
    ...
    @XmlElement(name = "CurCodeRates")
    protected List<CurCodeRatesType> curCodeRates;
    ...
    /**
     * Gets the value of the curCodeRates property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the curCodeRates property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCurCodeRates().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CurCodeRatesType }
     * 
     * 
     */
    public List<CurCodeRatesType> getCurCodeRates() {
        if (curCodeRates == null) {
            curCodeRates = new ArrayList<CurCodeRatesType>();
        }
        return this.curCodeRates;
    }
