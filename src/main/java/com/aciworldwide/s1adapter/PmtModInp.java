 ...
 *         &lt;element ref="{http://aciworldwide.com/S1Adapter}PmtModRq"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "PmtModInp")
public class PmtModInp {

    @XmlElement(name = "SignonRq", required = true)
    protected SignonRq signonRq;
    @XmlElement(name = "PmtModRq", required = true)
    protected PmtModRq pmtModRq;
     ...
     *     
     */
    public void setPmtModRq(PmtModRq value) {
        this.pmtModRq = value;
    }
