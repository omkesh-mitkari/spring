 ...
 *         &lt;/choice&gt;
 *         &lt;element ref="{http://aciworldwide.com/S1Adapter}Reissue"/&gt;
 *         &lt;element ref="{http://aciworldwide.com/S1Adapter}DeactivationCause"/&gt;
 *         &lt;element ref="{http://aciworldwide.com/S1Adapter}ATMCardRec"/&gt;
...
@XmlRootElement(name = "ATMCardDeactivateRq")
public class ATMCardDeactivateRq {
    ...
    @XmlElement(name = "Reissue", required = true)
    protected String reissue;
    @XmlElement(name = "DeactivationCause", required = true)
    @XmlSchemaType(name = "string")
    protected DeactivationCauseType deactivationCause;
    @XmlElement(name = "ATMCardRec", required = true)
    protected ATMCardRec atmCardRec;
    ...
    /**
     * Gets the value of the deactivationCause property.
     * 
     * @return
     *     possible object is
     *     {@link DeactivationCauseType }
     *     
     */
    public DeactivationCauseType getDeactivationCause() {
        return deactivationCause;
    }

    /**
     * Sets the value of the deactivationCause property.
     * 
     * @param value
     *     allowed object is
     *     {@link DeactivationCauseType }
     *     
     */
    public void setDeactivationCause(DeactivationCauseType value) {
        this.deactivationCause = value;
    }

    /**
     * Gets the value of the atmCardRec property.
     * 
     * @return
     *     possible object is
     *     {@link ATMCardRec }
     *     
     */
    public ATMCardRec getATMCardRec() {
        return atmCardRec;
    }

    /**
     * Sets the value of the atmCardRec property.
     * 
     * @param value
     *     allowed object is
     *     {@link ATMCardRec }
     *     
     */
    public void setATMCardRec(ATMCardRec value) {
        this.atmCardRec = value;
    }
