 ...
 *         &lt;element ref="{http://aciworldwide.com/S1Adapter}AcctGenInfo"/&gt;
...
@XmlRootElement(name = "AcctNumGenRq")
public class AcctNumGenRq {
    ...
    @XmlElement(name = "AcctGenInfo", required = true)
    protected AcctGenInfoType acctGenInfo;
    ...
    /**
     * Gets the value of the acctGenInfo property.
     * 
     * @return
     *     possible object is
     *     {@link AcctGenInfoType }
     *     
     */
    public AcctGenInfoType getAcctGenInfo() {
        return acctGenInfo;
    }

    /**
     * Sets the value of the acctGenInfo property.
     * 
     * @param value
     *     allowed object is
     *     {@link AcctGenInfoType }
     *     
     */
    public void setAcctGenInfo(AcctGenInfoType value) {
        this.acctGenInfo = value;
    }
