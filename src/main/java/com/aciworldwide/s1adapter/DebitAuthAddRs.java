 ...
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}DebitAuthRec"/&gt;
 *         &lt;/sequence&gt;
...
@XmlRootElement(name = "DebitAuthAddRs")
public class DebitAuthAddRs {
    ...
    @XmlElement(name = "DebitAuthInfo")
    protected DebitAuthInfo debitAuthInfo;
    @XmlElement(name = "DebitAuthRec")
    protected DebitAuthRec debitAuthRec;
    ...
    /**
     * Gets the value of the debitAuthRec property.
     * 
     * @return
     *     possible object is
     *     {@link DebitAuthRec }
     *     
     */
    public DebitAuthRec getDebitAuthRec() {
        return debitAuthRec;
    }

    /**
     * Sets the value of the debitAuthRec property.
     * 
     * @param value
     *     allowed object is
     *     {@link DebitAuthRec }
     *     
     */
    public void setDebitAuthRec(DebitAuthRec value) {
        this.debitAuthRec = value;
    }
