...
/**
 * S1 added element - Credit Card Account Memo Inquiry Response
 * 
 ...
 *         &lt;element ref="{http://aciworldwide.com/S1Adapter}CCAcctTrnRec" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlRootElement(name = "CCAcctMemoInqRs")
public class CCAcctMemoInqRs {
    ...
    protected List<CCAcctTrnRec> ccAcctTrnRec;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the ccAcctTrnRec property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCCAcctTrnRec().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CCAcctTrnRec> getCCAcctTrnRec() {
        if (ccAcctTrnRec == null) {
            ccAcctTrnRec = new ArrayList<CCAcctTrnRec>();
        }
        return this.ccAcctTrnRec;
    }
