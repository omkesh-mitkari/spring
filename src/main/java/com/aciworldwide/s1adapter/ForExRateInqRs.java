 ...
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}ForExRateRec" maxOccurs="unbounded"/&gt;
 *         &lt;/sequence&gt;
...
@XmlRootElement(name = "ForExRateInqRs")
public class ForExRateInqRs {
    ...
    @XmlElement(name = "ForExRateRec")
    protected List<ForExRateRec> forExRateRec;
    ...
    /**
     * Gets the value of the forExRateRec property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the forExRateRec property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getForExRateRec().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ForExRateRec> getForExRateRec() {
        if (forExRateRec == null) {
            forExRateRec = new ArrayList<ForExRateRec>();
        }
        return this.forExRateRec;
    }
