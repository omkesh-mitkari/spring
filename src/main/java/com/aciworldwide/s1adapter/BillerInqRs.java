 ...
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}NewUpDt" minOccurs="0"/&gt;
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}BillerRec" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;/sequence&gt;
...
@XmlRootElement(name = "BillerInqRs")
public class BillerInqRs {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the billerRec property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<BillerRecType> getBillerRec() {
        if (billerRec == null) {
            billerRec = new ArrayList<BillerRecType>();
        }
