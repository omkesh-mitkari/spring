 ...
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}CustPayeeInfo" minOccurs="0"/&gt;
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}CascadeDel" minOccurs="0"/&gt;
 *           &lt;choice minOccurs="0"&gt;
 *             &lt;element ref="{http://aciworldwide.com/S1Adapter}CustPayeeRec"/&gt;
 *             &lt;element ref="{http://aciworldwide.com/S1Adapter}DependentType" maxOccurs="unbounded"/&gt;
 *           &lt;/choice&gt;
...
@XmlRootElement(name = "CustPayeeDelRs")
public class CustPayeeDelRs {
    ...
    protected CustPayeeRec custPayeeRec;
    @XmlElement(name = "DependentType")
    protected List<String> dependentType;
     ...
     *     
     */
    public void setCustPayeeRec(CustPayeeRec value) {
     ...
     * This is why there is not a <CODE>set</CODE> method for the dependentType property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDependentType().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getDependentType() {
        if (dependentType == null) {
            dependentType = new ArrayList<String>();
        }
