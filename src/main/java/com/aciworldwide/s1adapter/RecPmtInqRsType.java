...
/**
 * <p>Java class for RecPmtInqRs_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RecPmtInqRs_Type"&gt;
 *   &lt;complexContent&gt;
 ...
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}RecPmtRec" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "RecPmtInqRs_Type", propOrder = {
    "status",
    "rqUID",
    "msgRqHdr",
    "msgRsHdr",
...
public class RecPmtInqRsType {
    ...
    protected List<RecPmtRec> recPmtRec;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the recPmtRec property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRecPmtRec().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<RecPmtRec> getRecPmtRec() {
        if (recPmtRec == null) {
            recPmtRec = new ArrayList<RecPmtRec>();
        }
        return this.recPmtRec;
    }
