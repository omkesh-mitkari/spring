 ...
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}BankAcctAuthRec" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;/sequence&gt;
...
@XmlRootElement(name = "BankAcctAuthInqRs")
public class BankAcctAuthInqRs {
    ...
    @XmlElement(name = "BankAcctAuthRec")
    protected List<BankAcctAuthRec> bankAcctAuthRec;
    ...
    /**
     * Gets the value of the bankAcctAuthRec property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the bankAcctAuthRec property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBankAcctAuthRec().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link BankAcctAuthRec }
     * 
     * 
     */
    public List<BankAcctAuthRec> getBankAcctAuthRec() {
        if (bankAcctAuthRec == null) {
            bankAcctAuthRec = new ArrayList<BankAcctAuthRec>();
        }
        return this.bankAcctAuthRec;
    }
