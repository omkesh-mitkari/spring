...
/**
 * S1 added element - Deposit Account Memo Inquiry Response
 * 
 ...
 *         &lt;element ref="{http://aciworldwide.com/S1Adapter}DepAcctTrnRec" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlRootElement(name = "DepAcctMemoInqRs")
public class DepAcctMemoInqRs {
    ...
    protected List<DepAcctTrnRec> depAcctTrnRec;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the depAcctTrnRec property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDepAcctTrnRec().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<DepAcctTrnRec> getDepAcctTrnRec() {
        if (depAcctTrnRec == null) {
            depAcctTrnRec = new ArrayList<DepAcctTrnRec>();
        }
        return this.depAcctTrnRec;
    }
