 ...
 *         &lt;element ref="{http://aciworldwide.com/S1Adapter}XferAddRq"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "XferAddInp")
public class XferAddInp {

    @XmlElement(name = "SignonRq", required = true)
    protected SignonRq signonRq;
    @XmlElement(name = "XferAddRq", required = true)
