 ...
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}CustTaxID" minOccurs="0"/&gt;
 ...
 *           &lt;/choice&gt;
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}RecordCount" minOccurs="0"/&gt;
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}ATMCardRec" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;/sequence&gt;
...
@XmlRootElement(name = "ATMCardListRs")
public class ATMCardListRs {
    ...
    protected List<ATMCardRec> atmCardRec;
     ...
     *     
     */
    public void setCustTaxID(String value) {
     ...
     * This is why there is not a <CODE>set</CODE> method for the atmCardRec property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getATMCardRec().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ATMCardRec> getATMCardRec() {
        if (atmCardRec == null) {
            atmCardRec = new ArrayList<ATMCardRec>();
        }
        return this.atmCardRec;
    }
