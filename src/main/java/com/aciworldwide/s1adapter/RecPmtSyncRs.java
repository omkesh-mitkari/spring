 ...
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}RecPmtMsgRec" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;/sequence&gt;
...
@XmlRootElement(name = "RecPmtSyncRs")
public class RecPmtSyncRs {
    ...
    @XmlElement(name = "RecPmtMsgRec")
    protected List<RecPmtMsgRec> recPmtMsgRec;
    ...
    /**
     * Gets the value of the recPmtMsgRec property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the recPmtMsgRec property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRecPmtMsgRec().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<RecPmtMsgRec> getRecPmtMsgRec() {
        if (recPmtMsgRec == null) {
            recPmtMsgRec = new ArrayList<RecPmtMsgRec>();
        }
        return this.recPmtMsgRec;
    }
