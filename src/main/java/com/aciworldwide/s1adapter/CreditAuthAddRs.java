 ...
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}CreditAuthRec"/&gt;
 *         &lt;/sequence&gt;
...
@XmlRootElement(name = "CreditAuthAddRs")
public class CreditAuthAddRs {
    ...
    @XmlElement(name = "CreditAuthInfo")
    protected CreditAuthInfo creditAuthInfo;
    @XmlElement(name = "CreditAuthRec")
    protected CreditAuthRec creditAuthRec;
    ...
    /**
     * Gets the value of the creditAuthRec property.
     * 
     * @return
     *     possible object is
     *     {@link CreditAuthRec }
     *     
     */
    public CreditAuthRec getCreditAuthRec() {
        return creditAuthRec;
    }

    /**
     * Sets the value of the creditAuthRec property.
     * 
     * @param value
     *     allowed object is
     *     {@link CreditAuthRec }
     *     
     */
    public void setCreditAuthRec(CreditAuthRec value) {
        this.creditAuthRec = value;
    }
