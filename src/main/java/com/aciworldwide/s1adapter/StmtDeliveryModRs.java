 ...
 *           &lt;/choice&gt;
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}MailDelivery"/&gt;
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}MailDeliveryStatus"/&gt;
 *         &lt;/sequence&gt;
...
@XmlType(name = "", propOrder = {
    ...
    "routeInfo",
    "custId",
    "depAcctIdOrCardAcctIdOrLoanAcctId",
    "tunneledData"
})
@XmlRootElement(name = "StmtDeliveryModRs")
public class StmtDeliveryModRs {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "CardAcctId", namespace = "http://aciworldwide.com/S1Adapter", type = CardAcctId.class),
        @XmlElementRef(name = "DepAcctId", namespace = "http://aciworldwide.com/S1Adapter", type = DepAcctId.class),
        @XmlElementRef(name = "MailDelivery", namespace = "http://aciworldwide.com/S1Adapter", type = JAXBElement.class),
        @XmlElementRef(name = "MailDeliveryStatus", namespace = "http://aciworldwide.com/S1Adapter", type = JAXBElement.class),
        @XmlElementRef(name = "LoanAcctId", namespace = "http://aciworldwide.com/S1Adapter", type = LoanAcctId.class)
    })
    protected List<Object> depAcctIdOrCardAcctIdOrLoanAcctId;
    ...
    /**
     * Gets the value of the depAcctIdOrCardAcctIdOrLoanAcctId property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the depAcctIdOrCardAcctIdOrLoanAcctId property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDepAcctIdOrCardAcctIdOrLoanAcctId().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getDepAcctIdOrCardAcctIdOrLoanAcctId() {
        if (depAcctIdOrCardAcctIdOrLoanAcctId == null) {
            depAcctIdOrCardAcctIdOrLoanAcctId = new ArrayList<Object>();
        }
        return this.depAcctIdOrCardAcctIdOrLoanAcctId;
    }
