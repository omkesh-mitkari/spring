 ...
 *         &lt;element ref="{http://aciworldwide.com/S1Adapter}NoteRange" minOccurs="0"/&gt;
 *         &lt;element ref="{http://aciworldwide.com/S1Adapter}MaxRec" minOccurs="0"/&gt;
...
@XmlRootElement(name = "LoanNoteListInqRq")
public class LoanNoteListInqRq {
    ...
    @XmlElement(name = "NoteRange")
    protected NoteRangeType noteRange;
    ...
    /**
     * Gets the value of the noteRange property.
     * 
     * @return
     *     possible object is
     *     {@link NoteRangeType }
     *     
     */
    public NoteRangeType getNoteRange() {
        return noteRange;
    }

    /**
     * Sets the value of the noteRange property.
     * 
     * @param value
     *     allowed object is
     *     {@link NoteRangeType }
     *     
     */
    public void setNoteRange(NoteRangeType value) {
        this.noteRange = value;
    }
