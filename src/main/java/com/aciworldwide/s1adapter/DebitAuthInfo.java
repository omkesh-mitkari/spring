 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://aciworldwide.com/S1Adapter}DebitAuthType"/&gt;
...
@XmlRootElement(name = "DebitAuthInfo")
public class DebitAuthInfo {

    @XmlElement(name = "DebitAuthType", required = true)
    protected String debitAuthType;
    ...
    /**
     * Gets the value of the debitAuthType property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getDebitAuthType() {
        return debitAuthType;
    }

    /**
     * Sets the value of the debitAuthType property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setDebitAuthType(String value) {
        this.debitAuthType = value;
    }
