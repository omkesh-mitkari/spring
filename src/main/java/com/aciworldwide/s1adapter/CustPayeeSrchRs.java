 ...
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}CustPayeeRec" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;/sequence&gt;
...
@XmlRootElement(name = "CustPayeeSrchRs")
public class CustPayeeSrchRs {
    ...
    protected List<CustPayeeRec> custPayeeRec;
     ...
     * This is why there is not a <CODE>set</CODE> method for the custPayeeRec property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCustPayeeRec().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CustPayeeRec> getCustPayeeRec() {
        if (custPayeeRec == null) {
            custPayeeRec = new ArrayList<CustPayeeRec>();
        }
        return this.custPayeeRec;
    }
