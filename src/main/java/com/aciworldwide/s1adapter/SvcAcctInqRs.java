 ...
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}NewUpDt"/&gt;
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}BankAcctRec" maxOccurs="unbounded" minOccurs="0"/&gt;
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}CustSvcRec" minOccurs="0"/&gt;
 *         &lt;/sequence&gt;
...
@XmlRootElement(name = "SvcAcctInqRs")
public class SvcAcctInqRs {
    ...
    @XmlElement(name = "NewUpDt")
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar newUpDt;
    @XmlElement(name = "BankAcctRec")
    protected List<BankAcctRec> bankAcctRec;
    @XmlElement(name = "CustSvcRec")
    protected CustSvcRec custSvcRec;
     ...
     *     
     */
    public XMLGregorianCalendar getNewUpDt() {
        return newUpDt;
    }
     ...
     *     
     */
    public void setNewUpDt(XMLGregorianCalendar value) {
        this.newUpDt = value;
    }
     ...
     * 
     */
    public List<BankAcctRec> getBankAcctRec() {
        if (bankAcctRec == null) {
            bankAcctRec = new ArrayList<BankAcctRec>();
        }
     ...
     *     
     */
    public CustSvcRec getCustSvcRec() {
        return custSvcRec;
    }
     ...
     *     
     */
    public void setCustSvcRec(CustSvcRec value) {
