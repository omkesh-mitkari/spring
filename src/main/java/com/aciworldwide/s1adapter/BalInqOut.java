 ...
 *         &lt;element ref="{http://aciworldwide.com/S1Adapter}BalInqRs" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "BalInqOut")
public class BalInqOut {

    @XmlElement(name = "Status")
    protected Status status;
    @XmlElement(name = "SignonRs")
    protected SignonRs signonRs;
    @XmlElement(name = "BalInqRs")
    protected BalInqRs balInqRs;
     ...
     *     
     */
    public void setBalInqRs(BalInqRs value) {
        this.balInqRs = value;
    }
