 ...
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}LoanNoteRec"/&gt;
 *         &lt;/sequence&gt;
...
@XmlRootElement(name = "LoanNoteInqRs")
public class LoanNoteInqRs {
    ...
    @XmlElement(name = "LoanNoteRec", required = true)
    protected LoanNoteRec loanNoteRec;
     ...
     *     
     */
    public LoanNoteRec getLoanNoteRec() {
        return loanNoteRec;
    }

    /**
     * Sets the value of the loanNoteRec property.
     * 
     * @param value
     *     allowed object is
     *     {@link LoanNoteRec }
     *     
     */
    public void setLoanNoteRec(LoanNoteRec value) {
        this.loanNoteRec = value;
    }
