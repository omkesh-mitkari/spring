 ...
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}LoanNoteRec" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;/sequence&gt;
...
@XmlRootElement(name = "LoanNoteListInqRs")
public class LoanNoteListInqRs {
    ...
    @XmlElement(name = "LoanNoteRec")
    protected List<LoanNoteRec> loanNoteRec;
    ...
    /**
     * Gets the value of the loanNoteRec property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the loanNoteRec property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getLoanNoteRec().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<LoanNoteRec> getLoanNoteRec() {
        if (loanNoteRec == null) {
            loanNoteRec = new ArrayList<LoanNoteRec>();
        }
        return this.loanNoteRec;
    }
