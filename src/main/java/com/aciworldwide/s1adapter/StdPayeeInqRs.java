 ...
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}StateProv" maxOccurs="unbounded" minOccurs="0"/&gt;
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}DeliveryMethod" minOccurs="0"/&gt;
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}StdPayeeRec" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;/sequence&gt;
...
@XmlRootElement(name = "StdPayeeInqRs")
public class StdPayeeInqRs {
    ...
    protected List<String> stateProv;
    @XmlElement(name = "DeliveryMethod")
    protected String deliveryMethod;
    @XmlElement(name = "StdPayeeRec")
    protected List<StdPayeeRec> stdPayeeRec;
    ...
    /**
     * S1 added element - allows payee lookup by state Gets the value of the stateProv property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the stateProv property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStateProv().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getStateProv() {
        if (stateProv == null) {
            stateProv = new ArrayList<String>();
        }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the stdPayeeRec property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStdPayeeRec().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<StdPayeeRec> getStdPayeeRec() {
        if (stdPayeeRec == null) {
            stdPayeeRec = new ArrayList<StdPayeeRec>();
        }
        return this.stdPayeeRec;
    }
