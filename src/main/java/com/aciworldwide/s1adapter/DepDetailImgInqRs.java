 ...
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}DepDetailImgInfo"/&gt;
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}Image" maxOccurs="unbounded" minOccurs="0"/&gt;
 *           &lt;element ref="{http://aciworldwide.com/S1Adapter}DepDetailImgIDRec" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;/sequence&gt;
...
@XmlRootElement(name = "DepDetailImgInqRs")
public class DepDetailImgInqRs {
    ...
    @XmlElement(name = "DepDetailImgInfo")
    protected DepDetailImgInfo depDetailImgInfo;
    @XmlElement(name = "Image")
    protected List<ImageType> image;
    @XmlElement(name = "DepDetailImgIDRec")
    protected List<DepDetailImgIDRec> depDetailImgIDRec;
    ...
    /**
     * Gets the value of the depDetailImgInfo property.
     * 
     * @return
     *     possible object is
     *     {@link DepDetailImgInfo }
     *     
     */
    public DepDetailImgInfo getDepDetailImgInfo() {
        return depDetailImgInfo;
    }

    /**
     * Sets the value of the depDetailImgInfo property.
     * 
     * @param value
     *     allowed object is
     *     {@link DepDetailImgInfo }
     *     
     */
    public void setDepDetailImgInfo(DepDetailImgInfo value) {
        this.depDetailImgInfo = value;
    }
    ...
    /**
     * Gets the value of the depDetailImgIDRec property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the depDetailImgIDRec property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDepDetailImgIDRec().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link DepDetailImgIDRec }
     * 
     * 
     */
    public List<DepDetailImgIDRec> getDepDetailImgIDRec() {
        if (depDetailImgIDRec == null) {
            depDetailImgIDRec = new ArrayList<DepDetailImgIDRec>();
        }
        return this.depDetailImgIDRec;
    }
